...
class RegisterViewModel(
    ...
    fun onRegisterClicked() {
        ...
        // **Kiểm tra tài khoản đã tồn tại chưa với AuthCache**
        if (authCache.isValidUser(usernameValue, phoneValue)) {
        ...
        if (success) {
            ...
            // **Lưu thông tin người dùng vào AuthCache**
            authCache.saveUserProfile(newUser)
